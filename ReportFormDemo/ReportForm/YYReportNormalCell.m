...
#import "YYReportNormalCell.h"
#import "YYReportLeftCell.h"
#import "YYReportContentCell.h"

static NSString* YYReportLeftCellIdentifier = @"YYReportLeftCellIdentifier";
static NSString* YYReportContentCellIdentifier = @"YYReportContentCellIdentifier";

@interface YYReportNormalCell () <UITableViewDelegate,UITableViewDataSource>
...
@implementation YYReportNormalCell
...
-(void) initView{
    ...
    [self.scrollViewTableView registerNib:[UINib nibWithNibName:@"YYReportContentCell" bundle:nil] forCellReuseIdentifier:YYReportLeftCellIdentifier];
    ...
    [self.lockViewTableView registerNib:[UINib nibWithNibName:@"YYReportLeftCell" bundle:nil] forCellReuseIdentifier:YYReportContentCellIdentifier];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (tableView==self.lockViewTableView) {
        YYReportLeftCell *cell=[tableView dequeueReusableCellWithIdentifier:YYReportContentCellIdentifier];
        ...
        YYReportContentCell *cell=[tableView dequeueReusableCellWithIdentifier:YYReportLeftCellIdentifier];
        cell.selectionStyle=UITableViewCellSelectionStyleNone;
        ...
        [rowDatas enumerateObjectsUsingBlock:^(NSString* rowData, NSUInteger idx, BOOL * _Nonnull stop) {
            ...
            dataView.font = weakSelf.textFont;
            dataView.textColor = weakSelf.textColor;
            dataView.textAlignment=NSTextAlignmentCenter;
            [view addSubview:dataView];
            
            view.layer.borderWidth = weakSelf.borderWidth;
            view.layer.borderColor = weakSelf.borderColor.CGColor;
