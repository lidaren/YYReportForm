...
#import "YYReportHeader.h"

static NSString* YYReportNormalCellIdentifier = @"YYReportNormalCellIdentifier";

@interface YYReportView () <UITableViewDelegate,UITableViewDataSource,UIScrollViewDelegate>
...
-(void)initView{
    ...
    [self.mTableView registerNib:[UINib nibWithNibName:@"YYReportNormalCell" bundle:[NSBundle mainBundle]] forCellReuseIdentifier:YYReportNormalCellIdentifier];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    YYReportNormalCell* cell = [self.mTableView dequeueReusableCellWithIdentifier:YYReportNormalCellIdentifier];
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    YYReportHeader *cell=[[[NSBundle mainBundle] loadNibNamed:@"YYReportHeader" owner:nil options:nil] lastObject];
